  ...
  return (
    <main style={{ minHeight: "100vh", background: neutrals.bg, color: neutrals.text, display: "flex", alignItems: "center", justifyContent: "center", padding: 20, fontFamily: "Inter, system-ui, sans-serif" }}>
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <h1 style={{ fontFamily: "Georgia, serif", fontSize: 26, textAlign: "center", margin: "0 0 4px" }}>NMAO Judge</h1>
        <p style={{ color: neutrals.muted, textAlign: "center", fontSize: 13, margin: "0 0 20px" }}>Sign in to score your assignments.</p>
        ...
        <button onClick={reset} style={{ width: "100%", marginTop: 8, padding: 8, background: "none", border: "none", color: neutrals.muted, cursor: "pointer", fontSize: 13 }}>
          First time here, or forgot your password? Email me a link to set one
        </button>
        {msg && <p style={{ color: msg.startsWith("Check") ? "#5DCAA5" : "#E07070", fontSize: 13, marginTop: 10, textAlign: "center" }}>{msg}</p>}
      </div>
    </main>
  );
}
